...
class SaleItemModel {
  ...
  @JsonKey(name: 'quantity_sold', fromJson: _decodeDouble)
  final double quantitySold;

  @JsonKey(name: 'unit_price', fromJson: _decodeDouble)
...
class SaleModel {
  ...
  double get totalRevenue => items.fold(0.0, (sum, item) => sum + item.revenue);
